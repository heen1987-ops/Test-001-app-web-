...
export function ConflictDialog() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-sm rounded-xl border border-border bg-surface p-5 shadow-card-md">
        <p className="font-extrabold tracking-tight text-foreground">저장 충돌이 발생했습니다</p>
        ...
        <button
          ...
          className="mt-4 w-full rounded-lg bg-accent px-4 py-2 text-sm font-bold text-white shadow-card hover:bg-accent-ink"
        >
          최신 내용 다시 불러오기
        </button>
      </div>
