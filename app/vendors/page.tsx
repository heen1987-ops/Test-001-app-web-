...
export default function VendorsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-xl font-extrabold tracking-tight text-foreground">업체·자료</h1>

      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-bold text-muted">업체</h2>
        ...
        <button type="button" onClick={openCreate} className="w-fit text-sm font-semibold text-accent-ink">
          + 자세히 입력해서 추가
        </button>
      </section>

      <section className="flex flex-col gap-3">
        <h2 className="text-sm font-bold text-muted">자료</h2>
